...
```javascript
lnf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-lnf@v0.0.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-lnf@v0.0.2-umd/browser.js"></script>
```
