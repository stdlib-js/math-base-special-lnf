...
```javascript
import lnf from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-lnf@v0.0.4-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-lnf/actions/workflows/test.yml/badge.svg?branch=v0.0.4
[test-url]: https://github.com/stdlib-js/math-base-special-lnf/actions/workflows/test.yml?query=branch:v0.0.4
